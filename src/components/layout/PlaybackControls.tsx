...
export function PlaybackControls() {
  ...
  return (
    <div className="border-t border-panel-border bg-panel-bg">
      ...
      {/* Annotation callout */}
      {step.annotation && (
        <div className="flex items-start gap-2 border-t border-slate-800/50 px-4 py-2 text-xs text-slate-400">
          <Lightbulb size={14} className="mt-0.5 shrink-0 text-amber-500/70" />
